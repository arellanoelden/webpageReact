    ...
    return (
      <section className="projects">
        ...
        <article className="project">
          <h2>Pokedex</h2>
          <a href="https://github.com/arellanoelden/pokedex">
            <img
          ...
          <p>
            ...
            in view and has full search functionality with type advantages.
            Fully a pwa and even can be toggled for darkmode.
          </p>
          <a
        ...
        <article className="project">
          <h2>TeamWatch</h2>
          <a href="https://github.com/arellanoelden/teamwatchfinal">
            <img
              alt="github logo link to project that is described"
              src={require("../images/github-logo48.png")}
              target="_blank"
        ...
        <article className="project">
          ...
          <p>
            Created a fairly straight forward adopt me web app when the user can
            look at what animals are up for adoption based off of location,
            animal type, and the breed of the animal. This app was created using
            React and it uses Redux for all of the state management.
          </p>
          <a
        ...
        <article className="project">
          <h2>UCSD mini</h2>
          <a href="https://github.com/arellanoelden/ucsdmini">
            <img
              alt="github logo link to project that is described"
              src={require("../images/github-logo48.png")}
              target="_blank"
          ...
          <p>
            ...
            a service worker for caching and more. Afterwards the page was a
            fully realized PWA and performed much better than before.
          </p>
          <a
        ...
        <article className="project">
          <h2>Webpage</h2>
          <a href="https://github.com/arellanoelden/webpageReact">
            <img
              alt="github logo link to project that is described"
              src={require("../images/github-logo48.png")}
              target="_blank"
          ...
          <p>
            This very site is created using React. I am toying with a ton of
            stuff to add. I plan on adding a tips and tricks section under
            "CoolCode" as well as implementing a blog in the near future where I
            can post my thoughts about web development. Additionally this is
            also a PWA and has a responsive design for smaller devices.
          </p>
        </article>
        <article className="project">
          <h2>Planit Triton</h2>
          <a href="https://github.com/aamirrasheed/ucsdplanner">
            <img
              alt="github logo link to project that is described"
              src={require("../images/github-logo48.png")}
              target="_blank"
        ...
        <article className="project">
          ...
          <a href="https://github.com/arellanoelden/reactExample">
            <img
              alt="github logo link to project that is described"
              src={require("../images/github-logo48.png")}
              target="_blank"
        ...
        <article className="project">
          <h2>Create a PWA</h2>
          <a href="https://github.com/arellanoelden/create_pwa">
            <img
              alt="github logo link to project that is described"
              src={require("../images/github-logo48.png")}
              target="_blank"
