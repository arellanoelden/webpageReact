  ...
  render() {
    return (
      <section className="projects">
        ...
        <article className="project">
            <h2>UCSD mini</h2>
            <a href="https://github.com/arellanoelden/ucsdmini"><img src={require("../images/github-logo48.png")} /></a>
        ...
        <article className="project">
            <h2>Webpage</h2>
            <a href="https://github.com/arellanoelden/webpageReact"><img src={require("../images/github-logo48.png")} /></a>
        ...
        <article className="project">
            <h2>Planit Triton</h2>
            <a href="https://github.com/aamirrasheed/ucsdplanner"><img src={require("../images/github-logo48.png")} /></a>
        ...
        <article className="project">
            ...
            <a href="https://github.com/arellanoelden/reactExample"><img src={require("../images/github-logo48.png")} /></a>
        ...
        <article className="project">
            <h2>Create a PWA</h2>
            <a href="https://github.com/arellanoelden/create_pwa"><img src={require("../images/github-logo48.png")} /></a>
