  ...
  render() {
    return (
      <section className="projects">
        ...
        <article className="project">
            <h2>Webpage</h2>
            <a href="https://github.com/arellanoelden/webpageReact"><img alt="github logo link to project that is described" src={require("../images/github-logo48.png")} target="_blank"/></a>
        ...
        <article className="project">
            <h2>Planit Triton</h2>
            <a href="https://github.com/aamirrasheed/ucsdplanner"><img alt="github logo link to project that is described" src={require("../images/github-logo48.png")} target="_blank"/></a>
        ...
        <article className="project">
            ...
            <a href="https://github.com/arellanoelden/reactExample"><img alt="github logo link to project that is described" src={require("../images/github-logo48.png")} target="_blank"/></a>
        ...
        <article className="project">
            <h2>Create a PWA</h2>
            <a href="https://github.com/arellanoelden/create_pwa"><img alt="github logo link to project that is described" src={require("../images/github-logo48.png")} target="_blank"/></a>
